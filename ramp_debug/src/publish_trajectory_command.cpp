...
int main(int argc, char** argv) {
  ...
  c1.motionState.positions.push_back(0.63855); // 0.70455
  c1.motionState.positions.push_back(0.364886); // 0.4026
  c1.motionState.positions.push_back(0.519146); // 0.519013
