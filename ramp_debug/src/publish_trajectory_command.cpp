...
int main(int argc, char** argv) {
  ...
  c1.motionState.positions.push_back(1);
  c1.motionState.positions.push_back(1);
  ...
  c3.motionState.positions.push_back(5.);
