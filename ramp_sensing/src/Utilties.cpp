...
reals Sigma (Data& data, CircleFit& circle)
{
    reals sum=0.,dx,dy;
...
reals SigmaReduced (Data& data, CircleFit& circle)
{
    int i,n=data.n;
...
reals SigmaReducedNearLinearCase (Data& data, CircleFit& circle)
{
    int i,n=data.n;
...
reals SigmaReducedForCenteredScaled (Data& data, CircleFit& circle)
{
    int i,n=data.n;
    reals sum=0.,dx,dy,r;
...
reals OptimalRadius (Data& data, CircleFit& circle)
{
    reals Mr=0.,dx,dy;
