...
void BezierCurve::initReflexxes() {
  ...
  reflexxesData_.inputParameters->MaxVelocityVector->VecData[0]     = fabs(0.33 / denom_v);
  reflexxesData_.inputParameters->MaxAccelerationVector->VecData[0] = fabs(0.33 / denom_a);
