...
Orig_Utility::Orig_Utility() {}

const uint8_t Orig_Utility::getQuadrant(const double angle) const {
...
const uint8_t Orig_Utility::getQuadrantOfVector(const std::vector<double> v) const {
...
const double Orig_Utility::positionDistance(const std::vector<double> a, const std::vector<double> b) const {
...
const double Orig_Utility::positionDistance(const trajectory_msgs::JointTrajectoryPoint point_a, const trajectory_msgs::JointTrajectoryPoint point_b) const {
...
const double Orig_Utility::findAngleToVector(const std::vector<double> p) const {
...
const double Orig_Utility::findAngleFromAToB(const trajectory_msgs::JointTrajectoryPoint a, const trajectory_msgs::JointTrajectoryPoint b) const {
  std::vector<double> c;
  std::vector<double> d;
...
const double Orig_Utility::findAngleFromAToB(const double x_prev, const double y_prev, const double x, const double y) const {
  std::vector<double> a, b;
...
const double Orig_Utility::findAngleFromAToB(const std::vector<double> a, const std::vector<double> b) const {
  double result;
...
const double Orig_Utility::findDistanceBetweenAngles(const double a1, const double a2) const {
  double result;
...
const double Orig_Utility::displaceAngle(const double a1, double a2) const {
...
const double Orig_Utility::getEuclideanDist(const std::vector<double> a, const std::vector<double> b) const {
  double result=0;
...
const ramp_msgs::Path Orig_Utility::getPath(const std::vector<ramp_msgs::MotionState> mps) const {
...
const ramp_msgs::Path Orig_Utility::getPath(const std::vector<ramp_msgs::KnotPoint> kps) const {
  ramp_msgs::Path result;
...
const ramp_msgs::KnotPoint Orig_Utility::getKnotPoint(const ramp_msgs::MotionState ms) const {
...
const trajectory_msgs::JointTrajectoryPoint Orig_Utility::getTrajectoryPoint(const ramp_msgs::MotionState ms) const {
...
const std::string Orig_Utility::toString(const ramp_msgs::MotionState mp) const {
...
const std::string Orig_Utility::toString(const ramp_msgs::KnotPoint kp) const {
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::Path path) const {
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const trajectory_msgs::JointTrajectoryPoint p) const {
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::RampTrajectory traj) const 
{
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::BezierCurve bi) const {
std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::TrajectoryRequest tr) const {
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::TrajectoryResponse tr) const
{
  std::ostringstream result;
...
const std::string Orig_Utility::toString(const ramp_msgs::TrajectorySrv srv) const
{
  std::ostringstream result;
